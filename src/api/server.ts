...
export const server_calls = {
    ...
    create: async (data: any = {}) => {
        ...
        if(!response.ok){
            throw new Error('Failed to create a new drone on server')
        }
        return await response.json()
    },
    update: async (id: string, data: any = {}) => {
        ...
        if(!response.ok){
            throw new Error('Failed to update a drone on server')
        }
        return await response.json()
    },
    delete: async (id: string) => {
        ...
        if(!response.ok){
            throw new Error('Failed to delete a drone on server')
        }
        return await response.json()
    }
